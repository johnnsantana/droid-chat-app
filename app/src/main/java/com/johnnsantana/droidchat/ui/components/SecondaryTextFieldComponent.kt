...
import com.johnnsantana.droidchat.ui.extension.bottomBorder
...
@Composable
private fun SecondaryTextFieldComponentPreview() {
    DroidChatTheme {
...
@Preview(showBackground = true)
@Composable
private fun SecondaryTextFieldPasswordComponent() {
    DroidChatTheme {
        SecondaryTextFieldComponent(
            label = "Password",
            value = "",
